...
public partial class Day12 : Advent.Day
{
    ...
    */
    public Day12(bool testMode, int whichPart) : base(testMode, whichPart)
    {
        ...
        {
            case (1, true):
                AddInput("<x=-8, y=-10, z=0>;<x=5, y=5, z=10>;<x=2, y=-7, z=3>;<x=9, y=-8, z=-3>");
                Expecteds.Add("1940");
                AddInput("<x=-1, y=0, z=2>;<x=2, y=-10, z=-7>;<x=4, y=-8, z=8>;<x=3, y=5, z=-1>");
                Expecteds.Add("179");
                break;
            case (1, false):
                AddInput("<x=1, y=3, z=-11>;<x=17, y=-10, z=-8>;<x=-1, y=-15, z=2>;<x=12, y=-4, z=-4>");
                Expecteds.Add("8310");
                break;
            case (2, true):
                AddInput("<x=-1, y=0, z=2>;<x=2, y=-10, z=-7>;<x=4, y=-8, z=8>;<x=3, y=5, z=-1>");
