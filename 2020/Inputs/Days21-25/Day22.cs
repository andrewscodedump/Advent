...
public partial class Day22 : Advent.Day
{
    ...
    */
    ...
    public Day22(bool testMode, int whichPart, string input) : base(testMode, whichPart, input)
    {
        ...
        {
            case (1, true):
                Inputs.Add("Player 1:;9;2;6;3;1;;Player 2:;5;8;4;7;10");
                Expecteds.Add("306");
                break;
            case (1, false):
                Inputs.Add("Player 1:;7;1;9;10;12;4;38;22;18;3;27;31;43;33;47;42;21;24;50;39;8;6;16;46;11;;Player 2:;49;41;40;35;44;29;30;19;14;2;34;17;25;5;15;32;20;48;45;26;37;28;36;23;13");
                Expecteds.Add("33403");
                break;
            case (2, true):
                Inputs.Add("Player 1:;9;2;6;3;1;;Player 2:;5;8;4;7;10");
