...
public partial class Day15 : Advent.Day
{
    ...
    */
    ...
    public Day15(bool testMode, int whichPart) : base(testMode, whichPart)
    {
        ...
        {
            case (1, true):
                AddInput("Butterscotch: capacity -1, durability -2, flavor 6, texture 3, calories 8;Cinnamon: capacity 2, durability 3, flavor -2, texture -1, calories 3");
                Expecteds.Add("62842880");
                break;
            case (1, false):
                AddInput("Sprinkles: capacity 2, durability 0, flavor -2, texture 0, calories 3;Butterscotch: capacity 0, durability 5, flavor -3, texture 0, calories 3;Chocolate: capacity 0, durability 0, flavor 5, texture -1, calories 8;Candy: capacity 0, durability -1, flavor 0, texture 5, calories 8");
