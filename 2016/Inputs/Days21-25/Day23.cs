...
public partial class Day23 : Advent.Day
{
    ...
    */
    public Day23(bool testMode, int whichPart, string input) : base(testMode, whichPart, input)
    {
        ...
        {
            case (1, true):
                Inputs.Add("cpy 41 a;inc a;inc a;dec a;jnz a 2;dec a");
                Expecteds.Add("42");
                break;
            case (1, false):
                Inputs.Add("cpy 1 a;cpy 1 b;cpy 26 d;jnz c 2;jnz 1 5;cpy 7 c;inc d;dec c;jnz c -2;cpy a c;inc a;dec b;jnz b -2;cpy c b;dec d;jnz d -6;cpy 19 c;cpy 11 d;inc a;dec d;jnz d -2;dec c;jnz c -5");
