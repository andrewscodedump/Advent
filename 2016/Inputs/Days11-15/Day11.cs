    ...
    public Day11(bool testMode, int whichPart) : base(testMode, whichPart)
    {
        switch (WhichPart, TestMode)
        {
            case (1, true):
                ...
                AddInput("The first floor contains a hydrogen-compatible microchip and a lithium-compatible microchip.;The second floor contains a hydrogen generator.;The third floor contains a lithium generator.;The fourth floor contains nothing relevant.");
                Expecteds.Add("11");
                break;
            case (1, false):
                BatchStatus = DayBatchStatus.NotWorking;
                AddInput("The first floor contains a polonium generator, a thulium generator, a thulium-compatible microchip, a promethium generator, a ruthenium generator, a ruthenium-compatible microchip, a cobalt generator, and a cobalt-compatible microchip.;The second floor contains a polonium-compatible microchip and a promethium-compatible microchip.;The third floor contains nothing relevant.;The fourth floor contains nothing relevant.");
                Expecteds.Add("");
                break;
            case (2, true):
                BatchStatus = DayBatchStatus.Performance;
